...
export function CookSpotlight() {
  return (
    <section id="cook" className="bg-[var(--color-deep-forest)] px-6 py-[110px] text-white sm:px-10 lg:px-16">
      <div className="mx-auto max-w-[1240px]">
        <div className="grid items-center gap-16 lg:grid-cols-2">
          ...
          <motion.div
            ...
            style={{ aspectRatio: "4/5", boxShadow: "0 30px 80px -26px rgba(0,0,0,0.5)" }}
          >
            <Image src="/working/img2.jpeg" alt="A home cook at her stove" fill sizes="(min-width: 1024px) 45vw, 100vw" className="object-cover" />
          </motion.div>
          ...
          <motion.div {...reveal} transition={{ ...reveal.transition, delay: 0.1 }}>
            ...
            <h2 className="mt-4 font-semibold text-white" style={{ fontSize: "clamp(36px, 5vw, 62px)", lineHeight: 1, letterSpacing: "-0.015em" }}>
              Cook at home <em className="font-medium" style={{ fontStyle: "italic", color: "var(--color-champagne)" }}>already?</em><br />Turn it into income.
            </h2>
            <p className="mt-7 max-w-[480px] leading-[1.4]" style={{ fontFamily: "var(--font-display)", fontStyle: "italic", fontSize: "22px", color: "var(--color-champagne)" }}>
              &ldquo;I cook for my family every day. Now I cook for ten more, and it pays my daughter&apos;s tuition.&rdquo;
            </p>
            <p className="mt-5 max-w-[480px] text-[16px] leading-relaxed text-white/78">
