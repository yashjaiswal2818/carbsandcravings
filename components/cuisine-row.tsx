...
export function MenuSection() {
  return (
    <section id="menu" className="bg-[var(--color-section)] px-6 py-[120px] sm:px-10 lg:px-16">
      <div className="mx-auto max-w-[1240px]">
        <motion.div {...reveal} className="mb-14 flex flex-wrap items-end justify-between gap-10">
          ...
          <p className="max-w-[420px] text-[17px] text-[#5b5a58]">Two homestyle plates, prepared fresh every day. Pick what fits your craving.</p>
        </motion.div>
        ...
        <div className="grid gap-5 sm:grid-cols-2">
          {menuCards.map((card, i) => (
            ...
            >
              ...
              <span className="absolute left-3.5 top-3.5 rounded-full bg-white/95 px-2.5 py-1.5 text-[10.5px] font-bold uppercase tracking-[0.12em] text-[var(--color-deep-forest)]">{card.badge}</span>
